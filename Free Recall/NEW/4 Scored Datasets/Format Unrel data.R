...
##Now subset out list type
l1 = subset(A,
            A$List_Type == "Unrel_Recall_L4")

length(unique(l1$Sub.ID)) ##We have the 20 participants from version A who completed this list

l2 = na.omit(l1)

l1.key = ver.A$Unrel_Recall_L4
...
l1 = subset(B,
            B$List_Type == "Unrel_Recall_L1")

length(unique(l1$Sub.ID)) ##We have the 20 participants from version A who completed this list

l2 = na.omit(l1)

l1.key = ver.B$Unrel_Recall_L1
...
l1 = subset(B,
            B$List_Type == "Unrel_Recall_L6")

length(unique(l1$Sub.ID)) ##We have the 20 participants from version A who completed this list

l2 = na.omit(l1)

l1.key = ver.B$Unrel_Recall_L6
