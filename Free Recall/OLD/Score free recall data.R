...
scoredA1 = score.recall.f(A1$response, key = ver.A$Cat_Recall_L1, id = A1$Sub.ID, cutoff = 0)
scoredA2 = score.recall.f(A2$response, key = ver.A$AdHoc_Recall_L2, id = A2$Sub.ID, cutoff = 0)
scoredA3 = score.recall.f(A3$response, key = ver.A$Unrel_Recall_L3, id = A3$Sub.ID, cutoff = 0)
scoredA4 = score.recall.f(A4$response, key = ver.A$Unrel_Recall_L4, id = A4$Sub.ID, cutoff = 0)
scoredA5 = score.recall.f(A5$response, key = ver.A$Cat_Recall_L5, id = A5$Sub.ID, cutoff = 0)
scoredA6 = score.recall.f(A6$response, key = ver.A$AdHoc_Recall_L6, id = A6$Sub.ID, cutoff = 0)
...
##Now version B
scoredB1 = score.recall.f(B1$response, key = ver.D$Unrel_Recall_L1, id = B1$Sub.ID, cutoff = 0) ##ver.B key didn't work for some reason. Using D since it contains the same items
scoredB2 = score.recall.f(B2$response, key = ver.B$AdHoc_Recall_L2, id = B2$Sub.ID, cutoff = 0)
scoredB3 = score.recall.f(B3$response, key = ver.B$AdHoc_Recall_L3, id = B3$Sub.ID, cutoff = 0)
scoredB4 = score.recall.f(B4$response, key = ver.B$Cat_Recall_L4, id = B4$Sub.ID, cutoff = 0)
scoredB5 = score.recall.f(B5$response, key = ver.B$Cat_Recall_L5, id = B5$Sub.ID, cutoff = 0)
scoredB6 = score.recall.f(B6$response, key = ver.B$Unrel_Recall_L6, id = B6$Sub.ID, cutoff = 0)
...
##Now version C
scoredC1 = score.recall.f(C1$response, key = ver.C$Cat_Recall_L1, id = C1$Sub.ID, cutoff = 0)
scoredC2 = score.recall.f(C2$response, key = ver.C$AdHoc_Recall_L2, id = C2$Sub.ID, cutoff = 0)
scoredC3 = score.recall.f(C3$response, key = ver.C$Unrel_Recall_L3, id = C3$Sub.ID, cutoff = 0)
scoredC4 = score.recall.f(C4$response, key = ver.C$Unrel_Recall_L4, id = C4$Sub.ID, cutoff = 0)
scoredC5 = score.recall.f(C5$response, key = ver.C$Cat_Recall_L5, id = C5$Sub.ID, cutoff = 0)
scoredC6 = score.recall.f(C6$response, key = ver.C$AdHoc_Recall_L6, id = C6$Sub.ID, cutoff = 0)
...
##Version D
scoredD1 = score.recall.f(D1$response, key = ver.D$Unrel_Recall_L1, id = D1$Sub.ID, cutoff = 0)
scoredD2 = score.recall.f(D2$response, key = ver.D$AdHoc_Recall_L2, id = D2$Sub.ID, cutoff = 0)
scoredD3 = score.recall.f(D3$response, key = ver.D$AdHoc_Recall_L3, id = D3$Sub.ID, cutoff = 0)
scoredD4 = score.recall.f(D4$response, key = ver.D$Cat_Recall_L4, id = D4$Sub.ID, cutoff = 0)
scoredD5 = score.recall.f(D5$response, key = ver.D$Cat_Recall_L5, id = D5$Sub.ID, cutoff = 0)
scoredD6 = score.recall.f(D6$response, key = ver.D$Unrel_Recall_L6, id = D6$Sub.ID, cutoff = 0)
...
##Version E
scoredE1 = score.recall.f(E1$response, key = ver.E$Cat_Recall_L1, id = E1$Sub.ID, cutoff = 0)
scoredE2 = score.recall.f(E2$response, key = ver.E$AdHoc_Recall_L2, id = E2$Sub.ID, cutoff = 0)
scoredE3 = score.recall.f(E3$response, key = ver.E$Unrel_Recall_L3, id = E3$Sub.ID, cutoff = 0)
scoredE4 = score.recall.f(E4$response, key = ver.E$Unrel_Recall_L4, id = E4$Sub.ID, cutoff = 0)
scoredE5 = score.recall.f(E5$response, key = ver.E$Cat_Recall_L5, id = E5$Sub.ID, cutoff = 0)
scoredE6 = score.recall.f(E6$response, key = ver.C$AdHoc_Recall_L6, id = E6$Sub.ID, cutoff = 0) ##E didn't work here but c did (they should contain the same items...)
...
##Now version F
scoredF1 = score.recall.f(F1$response, key = ver.D$Unrel_Recall_L1, id = F1$Sub.ID, cutoff = 0) #f didn't work so used D
scoredF2 = score.recall.f(F2$response, key = ver.F$AdHoc_Recall_L2, id = F2$Sub.ID, cutoff = 0)
scoredF3 = score.recall.f(F3$response, key = ver.F$AdHoc_Recall_L3, id = F3$Sub.ID, cutoff = 0)
scoredF4 = score.recall.f(F4$response, key = ver.F$Cat_Recall_L4, id = F4$Sub.ID, cutoff = 0)
scoredF5 = score.recall.f(F5$response, key = ver.F$Cat_Recall_L5, id = F5$Sub.ID, cutoff = 0)
scoredF6 = score.recall.f(F6$response, key = ver.F$Unrel_Recall_L6, id = F6$Sub.ID, cutoff = 0)
...
write.csv(Cat.proportions, file = "Cat0.csv", row.names = F)
write.csv(Unrel.Proportions, file = "Unrel0.csv", row.names = F)
write.csv(Ad_hoc.Proportions, file = "AdHoc0.csv", row.names = F)
